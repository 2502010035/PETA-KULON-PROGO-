...
map.getView().fit([12167983.984846, -957761.084097, 12363637.978314, -795599.980589], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">PETA KULON PROGO YOGYAKARTA</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (98 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'PETA KEPADATAN PENDUDUK<br />NAMA: VIYOLINA AURELLIA TARIGAN<br />NO PRESENSI: 35<br />KELAS: SPIP A<br />KODE SOAL: E';
            }
